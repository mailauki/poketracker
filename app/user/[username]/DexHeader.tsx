        ...
        <div className="w-full flex items-center justify-between">
          <div className="flex items-center gap-2">
            {dex ? (
              ...
              <>
                <Link href={`${pathname}/${pokedex.hash}`} className="text-2xl font-medium text-blue-600 underline dark:text-blue-500 hover:no-underline">{pokedex.title}</Link>
                <button type="button" className="text-gray-500 dark:text-gray-400 bg-transparent hover:text-gray-900 rounded-full text-sm w-9 h-9 ms-auto inline-flex justify-center items-center dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-900" onClick={() => console.log("edit", pokedex)}>
